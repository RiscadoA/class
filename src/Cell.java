...
interface Cell {
    ...
    void put(String _chi, ASTNode _rhs, Env<EnvEntry> _ep, Env<LinSession> _ed,  Env<Server> _eg) throws Exception;
    void free() throws Exception;
    void setCell(String _chi, ASTNode _rhs, Env<EnvEntry> _ep, Env<LinSession> _ed,
                 Env<Server> _eg, Logger logger, boolean _linear);
