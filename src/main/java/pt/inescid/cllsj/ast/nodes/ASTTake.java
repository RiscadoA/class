...
public class ASTTake extends ASTNode {
  ...
  public void samLTake(
      MVar var, SessionClosure clos, Env<SessionField> frame, Env<EnvEntry> ep, SAMCont p_cont)
      throws Exception {
    if (CLLSj.trace) {
  ...
  public void samL(Env<SessionField> frame, Env<EnvEntry> ep, SAMCont p_cont) throws Exception {
    ...
    if (sf instanceof MVar) {
      ...
      if (!srec.getPol()) {
        ...
        if (cell == null) throw new SAMError("SAM-TAKE-read-FAILURE " + chr + " " + srec);
