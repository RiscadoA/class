...
public class CGenerator extends IRInstructionVisitor {
  ...
  public void visit(IRBindSession instr) {
    ...
    putAssign(sessionContSessionOffset(remoteSession), currentProcessLayout.sessionOffset(instr.getSessionId()));
    putAssign(sessionContDataOffset(remoteSession), currentProcessLayout.dataOffset(instr.getLocation().getLocalDataId()));
