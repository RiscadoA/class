...
public class IRProcessOld {
  ...
  public IRProcessOld(
    ...
    this.entry = new IRBlockOld(null);
  ...
  public IRBlockOld getEntry() {
    return entry;
  }

  public IRBlockOld addBlock(String type) {
    IRBlockOld block = new IRBlockOld(type + "_" + blocks.size());
    blocks.add(block);
    return block;
  }

  public List<IRBlockOld> getBlocks() {
    return blocks;
  }

  public List<IRBlockOld> getBlocksIncludingEntry() {
  ...
  public IRBlockOld getBlock(String label) {
    for (IRBlockOld block : blocks) {
