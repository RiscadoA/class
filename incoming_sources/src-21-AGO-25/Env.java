...
public class Env<X> {
    ...
    synchronized public boolean eqlin(Env<ASTType> e0) {
	if (anc!=null && !anc.eqlin(e0.anc)) return false;
	System.out.println("assoc "+assoc+" "+e0.assoc);
	return (assoc == e0.assoc) || (e0.assoc instanceof ASTCoBasicType) || (assoc instanceof ASTCoBasicType);
    }
    ...
    synchronized public void upd(String _id, X _assoc) throws
	Exception {
